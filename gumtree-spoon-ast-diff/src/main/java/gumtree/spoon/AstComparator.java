...
public class AstComparator {
	...
	public CtType toCt(File f1) throws Exception{
		return getCtType(f1);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		CtType tempCt = new AstComparator().toCt(new File(args[0]));
		System.out.println(tempCt.toString());
		for(CtElement tempNode: tempCt.getDirectChildren()) {
